...
class __TwigTemplate_24ffb6ca0a906ed33bb033b668d93c34 extends Template
{
...
\t\t\t\t<td>{{ b.name }}</td>
\t\t\t\t<td class=\"flex center\">
\t\t\t\t\t{% include \"@common/actionButton.html.twig\" with {'controller':'branches','method':'branch', 'id':
\t\t\t\t\tb.id}%}
\t\t\t\t</td>
\t\t\t</tr>
\t\t\t{% endfor %}
...
\t\t</tbody>
\t</table>
</div>", "@tables/branch.html.twig", "/var/www/src/views/components/@tables/branch.html.twig");
    }
}
