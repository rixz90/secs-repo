...
class __TwigTemplate_69335886ce23ae6cb646b42bb42238c2 extends Template
{
...
";
    ...
    {
        return new Source("{% for location in locations %}
<li>
    <label>
        <input type=\"checkbox\" name=\"locations[]\" value=\"{{ location.id }}\" /> {{ location.address }}
    </label>
</li>
{% endfor %}", "@lists/locationListForm.html.twig", "/var/www/src/views/components/@lists/locationListForm.html.twig");
    }
}
