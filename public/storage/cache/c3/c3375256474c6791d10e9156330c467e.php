...
/* setting.html.twig */
class __TwigTemplate_188deee84f27f199f8d478f7f50b6f22 extends Template
{
...
\t<section>
\t\t<div x-show=\"adm\" x-collapse>
\t\t\t{{ include('@panels/adminPanel.html.twig', with_context:false) }}
\t\t</div>
\t\t<div x-show=\"bra\" x-collapse>
\t\t\t{{ include('@panels/branchPanel.html.twig', with_context:false) }}
\t\t</div>
\t\t<div x-show=\"cat\" x-collapse>
\t\t\t{{ include('@panels/categoryPanel.html.twig', with_context:false) }}
\t\t</div>
\t\t<div x-show=\"loc\" x-collapse>
\t\t\t{{ include('@panels/locationPanel.html.twig', with_context:false) }}
\t\t</div>
\t</section>
</main>
{% endblock %}", "setting.html.twig", "/var/www/src/views/setting.html.twig");
    }
}
