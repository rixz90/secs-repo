...
class __TwigTemplate_9d35974b679a9b8f636a6a0ff689e4a1 extends Template
{
...
\t\t\t\t<td>{{ c.name }}</td>
\t\t\t\t<td class=\"flex center\">
\t\t\t\t\t{% include \"@common/actionButton.html.twig\" with {'controller':'categories','method':'category',
\t\t\t\t\t'id': c.id}%}
\t\t\t\t</td>
\t\t\t</tr>
\t\t\t{% endfor %}
...
\t\t</tbody>
\t</table>
</div>", "@tables/category.html.twig", "/var/www/src/views/components/@tables/category.html.twig");
    }
}
